...
class Zippy_Databases
{
    ...
    protected static $db_version = '1.1';
    ...
    {
        register_activation_hook(ZIPPY_ADDONS_BASENAME, [$this, 'install']);
    ...
    public function install()
    {
        ...
        $this->create_outlet_table();
        $this->create_menus_table();
        $this->create_menu_products_table();
        $this->create_shipping_table();

        update_option('zippy_db_version', self::$db_version);
    }

    public function check_update()
    {
        $installed_ver = get_option('zippy_db_version');
    ...
    public function create_outlet_table()
    {
        ...
        $sql = "CREATE TABLE $table_name (
            ...
            type INT(11) NULL,
            start_date LONGTEXT NULL,
            end_date LONGTEXT NULL,
            limit_order INT(11) NULL,
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
